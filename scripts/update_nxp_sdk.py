...
def NxpSdk_k32w0():
    rel_path_k32w0 = 'github_sdk/k32w0'
    sdk = NxpSdk('k32w0', os.path.abspath(os.path.join(NXP_MATTER_SUPPORT_ROOT, rel_path_k32w0)))
    return sdk

def NxpSdk_common():
    rel_path_common = 'github_sdk/rw_k32w1'
    sdk = NxpSdk('common', os.path.abspath(os.path.join(NXP_MATTER_SUPPORT_ROOT, rel_path_common)))
    return sdk

def NxpSdk_rt():
    rel_path_rt = 'github_sdk/rt'
    sdk = NxpSdk('rt', os.path.abspath(os.path.join(NXP_MATTER_SUPPORT_ROOT, rel_path_rt)))
    return sdk
