...
function(nxp_sign_app_imgtool bin_sections_to_remove)
    ...
    add_custom_command(
        OUTPUT ${gn_build}/${PROJECT_NAME}.bin
        COMMAND arm-none-eabi-objcopy ${bin_sections_to_remove} -O binary ${gn_build}/${PROJECT_NAME} ${gn_build}/${PROJECT_NAME}.bin
    ...
    add_custom_target(sign_application ALL
        COMMAND ${Python3_EXECUTABLE} imgtool.py sign --key ${MCUBOOT_EXAMPLE_DIR}/keys/sign-rsa2048-priv.pem --align 4 --header-size ${CONFIG_CHIP_MCUBOOT_HEADER_SIZE} --pad-header
               --slot-size ${CONFIG_CHIP_MCUBOOT_SLOT_SIZE} --max-sectors ${CONFIG_CHIP_MCUBOOT_MAX_SECTORS} --version ${CONFIG_CHIP_DEVICE_SOFTWARE_VERSION_STRING} ${CONFIG_MCUBOOT_ADDITIONAL_ARGS} ${gn_build}/${PROJECT_NAME}.bin ${gn_build}/${PROJECT_NAME}_SIGNED.bin
        WORKING_DIRECTORY ${MCUBOOT_OPENSOURCE_DIR}/scripts
        DEPENDS ${gn_build}/${PROJECT_NAME}.bin
...
function(nxp_generate_ota_file)
    ...
    add_custom_target(chip-ota-image ALL
        COMMAND ./ota_image_tool.py create -v ${CONFIG_CHIP_DEVICE_VENDOR_ID} -p ${CONFIG_CHIP_DEVICE_PRODUCT_ID} -vn ${CONFIG_CHIP_DEVICE_SOFTWARE_VERSION} -vs ${CONFIG_CHIP_DEVICE_SOFTWARE_VERSION_STRING} -da sha256 ${gn_build}/${PROJECT_NAME}_SIGNED.bin ${gn_build}/${PROJECT_NAME}.ota
