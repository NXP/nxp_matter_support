...
if(CONFIG_CHIP_SDK_DEPENDENCIES)
    ...
    mcux_add_configuration(
        CC " -Wno-maybe-uninitialized -Wno-unused-variable -march=armv8-m.main -std=gnu11 -save-temps"
        CX " -std=gnu++17 -Wno-maybe-uninitialized -Wno-unused-variable -march=armv8-m.main -save-temps"
    )
    ...
    # ========================================================================================
    mcux_add_configuration(
        LD " \ -Wl,--defsym=__stack_size__=2048 \ -ffreestanding \ -fno-builtin \ -u flexspi_config \ -u image_vector_table \ -u boot_data \ -u dcd_data \ -Wl,--wrap=malloc \ -Wl,--wrap=free \ -Wl,--wrap=realloc \ -Wl,--wrap=calloc \ -Wl,--wrap=MemoryAlloc \ -Wl,--wrap=exit \ -Wl,--wrap=printf \ -Wl,--wrap=_malloc_r \ -Wl,--wrap=_realloc_r \ -Wl,--wrap=_free_r \ -Wl,--wrap=_calloc_r \ ")
